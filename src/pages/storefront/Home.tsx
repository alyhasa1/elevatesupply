...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#faf9f8] overflow-x-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 py-12 sm:py-16 lg:py-20">
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="max-w-2xl">
              <Badge
                variant="outline"
                className="mb-4 rounded-full border-rose-800/50 bg-rose-950/50 px-3 py-1 text-[10px] font-semibold uppercase tracking-widest text-rose-200 backdrop-blur-md"
              >
                Premium Fulfilment
              </Badge>
              ...
              <div className="mb-6 flex flex-col gap-3 sm:flex-row">
                <Link to="/catalog" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="h-12 w-full rounded-full bg-rose-700 px-6 text-base text-white shadow-[0_0_40px_-10px_rgba(225,29,72,0.4)] transition-all hover:scale-[1.02] hover:bg-rose-600 sm:w-auto"
                  >
                    Browse Catalog
                  </Button>
                </Link>
              </div>
              <div className="grid grid-cols-1 gap-x-4 gap-y-3 text-sm font-medium text-stone-400 sm:grid-cols-2">
            ...
            <div className="relative hidden lg:block">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl border border-stone-800/50 shadow-2xl transition-transform duration-700 hover:rotate-0 lg:rotate-2">
                ...
                <div className="absolute bottom-6 left-4 right-4 rounded-xl border border-stone-700/50 bg-stone-900/80 p-4 shadow-2xl backdrop-blur-md lg:-rotate-2">
                  <div className="mb-3 flex items-center justify-between">
                    <div className="text-sm font-medium uppercase tracking-wider text-stone-300">Live Inventory</div>
                    <TrendingUp className="h-4 w-4 text-rose-400" />
                  </div>
                  <div className="mb-1 text-2xl font-semibold text-white">{data.liveCount} products tracked</div>
          ...
          <div className="mb-8 flex flex-col gap-4 md:mb-10 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              <div className="mb-3 flex items-center gap-3">
                <div className="h-px w-10 bg-rose-700" />
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8 flex flex-col gap-4 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mb-2 text-2xl font-bold tracking-tight text-stone-900">Recently Updated Products</h2>
      ...
      <section className="relative overflow-hidden bg-stone-950 py-16 text-white sm:py-20 lg:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="mx-auto mb-12 max-w-3xl text-center sm:mb-16">
            <h2 className="mb-4 text-2xl font-bold tracking-tight sm:text-3xl">Streamlined Operations</h2>
          ...
          <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
            <div className="absolute left-[15%] right-[15%] top-14 z-0 hidden h-px bg-gradient-to-r from-transparent via-stone-700 to-transparent md:block" />

            <div className="group relative z-10 text-center">
              <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-stone-800 bg-stone-900 shadow-2xl transition-colors duration-500 group-hover:border-rose-800 sm:h-28 sm:w-28">
                <Search className="h-9 w-9 text-rose-500 sm:h-10 sm:w-10" />
              </div>
              <h3 className="mb-3 text-xl font-semibold">1. Browse & List</h3>
              <p className="text-base font-light leading-relaxed text-stone-400">
            ...
            <div className="group relative z-10 text-center">
              <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-stone-800 bg-stone-900 shadow-2xl transition-colors duration-500 group-hover:border-rose-800 sm:h-28 sm:w-28">
                <ShoppingCart className="h-9 w-9 text-rose-500 sm:h-10 sm:w-10" />
              </div>
              <h3 className="mb-3 text-xl font-semibold">2. Receive Orders</h3>
              <p className="text-base font-light leading-relaxed text-stone-400">
            ...
            <div className="group relative z-10 text-center">
              <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-stone-800 bg-stone-900 shadow-2xl transition-colors duration-500 group-hover:border-rose-800 sm:h-28 sm:w-28">
                <Truck className="h-9 w-9 text-rose-500 sm:h-10 sm:w-10" />
              </div>
              <h3 className="mb-3 text-xl font-semibold">3. We Fulfil</h3>
              <p className="text-base font-light leading-relaxed text-stone-400">
      ...
      <section className="relative overflow-hidden bg-rose-950 py-16 sm:py-20 lg:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="mx-auto max-w-4xl rounded-2xl border border-rose-900/50 bg-stone-950/60 p-6 text-center shadow-2xl backdrop-blur-xl sm:p-8 md:p-12">
            <h2 className="mb-4 text-2xl font-bold tracking-tight text-white sm:text-3xl">Stay Ahead of the Market</h2>
            <p className="mx-auto mb-8 max-w-2xl text-base font-light text-rose-200/80">
            ...
            <form className="mx-auto flex max-w-xl flex-col gap-3 sm:flex-row">
              <input
                ...
                className="h-12 flex-1 rounded-full border border-stone-700 bg-stone-900/80 px-5 text-white placeholder:text-stone-500 focus:outline-none focus:ring-2 focus:ring-rose-600"
                required
              />
              <Button
                type="submit"
                className="h-12 rounded-full bg-rose-700 px-8 text-base font-semibold text-white shadow-lg shadow-rose-900/20 transition-all hover:scale-[1.02] hover:bg-rose-600"
              >
                Subscribe
              </Button>
            </form>

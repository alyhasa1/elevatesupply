...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      <section className="relative flex min-h-[50vh] items-center overflow-hidden bg-stone-950 text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 py-14 sm:py-18 lg:py-24">
      ...
      <section className="bg-[#faf9f8] py-12 sm:py-16">
        <div className="container mx-auto px-4">
          ...
          {featuredStatus === "error" && <div className="text-rose-700">{featuredError || "Catalog could not be loaded."}</div>}
          {featuredStatus === "ready" && allFeaturedProducts.length > 0 && (
            <>
              ...
              <div className="mt-8 flex justify-center">
                <Link to="/catalog">
                  <Button className="h-12 rounded-full bg-rose-700 px-8 text-base text-white shadow-lg shadow-rose-900/20 transition-all hover:scale-[1.02] hover:bg-rose-600">
                    Browse All Products
